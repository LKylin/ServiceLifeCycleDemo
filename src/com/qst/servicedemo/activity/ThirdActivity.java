...
import com.qst.servicedemo.R.id;
...
//			startActivity(intentNext);
		...
		case R.id.act_third_bind:
			...
			break;
		case R.id.act_third_unbind:
			unbindService(mServiceConn);
			break;
		case R.id.act_third_stop:
